    ...
    */
    RGraph.Line = function (idOrElement)
    {
        // Get the canvas and context objects
        this.id                = (typeof(idOrElement) === "string")? idOrElement : idOrElement.id;
        this.canvas            = (typeof(idOrElement) === "string")? document.getElementById(idOrElement): idOrElement;						
